...
public class DongTacLungAdapter extends BaseAdapter {
    private ChiTietDongTacLungActivity context;
    private  int layout;
    private List<DongTac> dongTacLungList;

    public DongTacLungAdapter(ChiTietDongTacLungActivity context, int layout, List<DongTac> dongTacLungList) {
        this.context = context;
        this.layout = layout;
        this.dongTacLungList = dongTacLungList;
    }

    @Override
    public int getCount() {
        return dongTacLungList.size();
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        DongTacLungAdapter.ViewHolder holder;
        if(view==null){
            holder=new DongTacLungAdapter.ViewHolder();
            ...
            holder=(DongTacLungAdapter.ViewHolder) view.getTag();
        }
        DongTac dongTac=dongTacLungList.get(i);
