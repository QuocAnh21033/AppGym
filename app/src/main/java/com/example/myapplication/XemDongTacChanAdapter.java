...
public class XemDongTacChanAdapter extends BaseAdapter {
    private Context context;
    private  int layout;
    private List<DongTac> dongTacChanList;

    public XemDongTacChanAdapter(Context context, int layout, List<DongTac> dongTacChanList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        XemDongTacChanAdapter.ViewHolder holder;
        if (view == null) {
            holder = new XemDongTacChanAdapter.ViewHolder();
            ...
            holder = (XemDongTacChanAdapter.ViewHolder) view.getTag();
        }
