...
public class DongTacChanAdapter extends BaseAdapter {
    private ChiTietDongTacChanActivity context;
    private  int layout;
    private List<DongTac> dongTacChanList;

    public DongTacChanAdapter(ChiTietDongTacChanActivity context, int layout, List<DongTac> dongTacChanList) {
        this.context = context;
        this.layout = layout;
        this.dongTacChanList = dongTacChanList;
    }

    @Override
    public int getCount() {
        return dongTacChanList.size();
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        DongTacChanAdapter.ViewHolder holder;
        if (view == null) {
            holder = new DongTacChanAdapter.ViewHolder();
            ...
            holder = (DongTacChanAdapter.ViewHolder) view.getTag();
        }
        DongTac dongTac = dongTacChanList.get(i);
