...
public class DongTacMongAdapter extends BaseAdapter {
    private ChiTietDongTacMongActivity context;
    private  int layout;
    private List<DongTac> dongTacMongList;

    public DongTacMongAdapter(ChiTietDongTacMongActivity context, int layout, List<DongTac> dongTacMongList) {
        this.context = context;
        this.layout = layout;
        this.dongTacMongList = dongTacMongList;
    }

    @Override
    public int getCount() {
        return dongTacMongList.size();
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        DongTacMongAdapter.ViewHolder holder;
        if(view==null){
            holder=new DongTacMongAdapter.ViewHolder();
            ...
            holder=(DongTacMongAdapter.ViewHolder) view.getTag();
        }
        DongTac dongTac=dongTacMongList.get(i);
