...
public class XemDongTacMongAdapter extends BaseAdapter {
    private Context context;
    private  int layout;
    private List<DongTac> dongTacMongList;

    public XemDongTacMongAdapter(Context context, int layout, List<DongTac> dongTacMongList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        XemDongTacMongAdapter.ViewHolder holder;
        if (view == null) {
            holder = new XemDongTacMongAdapter.ViewHolder();
            ...
            holder = (XemDongTacMongAdapter.ViewHolder) view.getTag();
        }
