...
public class DongTacNgucAdapter extends BaseAdapter {
    private ChiTietDongTacNgucActivity context;
    private  int layout;
    private List<DongTac> dongTacNgucList;

    public DongTacNgucAdapter(ChiTietDongTacNgucActivity context, int layout, List<DongTac> dongTacNgucList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        DongTacNgucAdapter.ViewHolder holder;
        if(view==null){
            holder=new DongTacNgucAdapter.ViewHolder();
            ...
            holder=(DongTacNgucAdapter.ViewHolder) view.getTag();
        }
