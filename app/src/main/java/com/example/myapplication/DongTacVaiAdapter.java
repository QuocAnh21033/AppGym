...
public class DongTacVaiAdapter extends BaseAdapter {
    private ChiTietDongTacVaiActivity context;
    private  int layout;
    private List<DongTac> dongTacList;

    public DongTacVaiAdapter(ChiTietDongTacVaiActivity context, int layout, List<DongTac> dongTacList) {
