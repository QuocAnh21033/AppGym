...
public class XemDongTacLungAdapter extends BaseAdapter {
    private Context context;
    private  int layout;
    private List<DongTac> dongTacLungList;

    public XemDongTacLungAdapter(Context context, int layout, List<DongTac> dongTacLungList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        XemDongTacLungAdapter.ViewHolder holder;
        if (view == null) {
            holder = new XemDongTacLungAdapter.ViewHolder();
            ...
            holder = (XemDongTacLungAdapter.ViewHolder) view.getTag();
        }
