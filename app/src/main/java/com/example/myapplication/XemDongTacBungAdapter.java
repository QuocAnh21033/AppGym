...
public class XemDongTacBungAdapter extends BaseAdapter {
    private Context context;
    private  int layout;
    private List<DongTac> dongTacBungList;

    public XemDongTacBungAdapter(Context context, int layout, List<DongTac> dongTacBungList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        XemDongTacBungAdapter.ViewHolder holder;
        if(view==null){
            holder=new XemDongTacBungAdapter.ViewHolder();
            ...
            holder=(XemDongTacBungAdapter.ViewHolder) view.getTag();
        }
