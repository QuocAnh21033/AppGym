...
public class DongTacBungAdapter extends BaseAdapter {
    private ChiTietDongTacBungActivity context;
    private  int layout;
    private List<DongTac> dongTacBungList;

    public DongTacBungAdapter(ChiTietDongTacBungActivity context, int layout, List<DongTac> dongTacBungList) {
        this.context = context;
        this.layout = layout;
        this.dongTacBungList = dongTacBungList;
    }


    @Override
    public int getCount() {
        return dongTacBungList.size();
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        DongTacBungAdapter.ViewHolder holder;
        if(view==null){
            holder=new DongTacBungAdapter.ViewHolder();
            ...
            holder=(DongTacBungAdapter.ViewHolder) view.getTag();
        }

        DongTac dongTac=dongTacBungList.get(i);
